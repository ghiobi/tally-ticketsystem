...
Route.group(() => {
  ...
  Route.get('/ticket/:ticket_id', 'Ticket/TicketController.index').middleware('IsTicketOwnerOrIsAdmin')
  Route.post('/ticket/:ticket_id', 'Ticket/TicketController.update').middleware('IsTicketOwnerOrIsAdmin')
  Route.post('/ticket/:ticket_id/download', 'Ticket/TicketController.download').middleware('IsTicketOwnerOrIsAdmin')
  Route.post('/ticket/:ticket_id/reply', 'Ticket/TicketController.reply').middleware('IsTicketOwnerOrIsAdmin')
  Route.post('/ticket/:ticket_id/resolve', 'Ticket/TicketController.resolve').middleware('IsTicketOwnerOrIsAdmin')
