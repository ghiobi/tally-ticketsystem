...
// }).timeout(30000)
//
// test('Admin clicks submit ticket should be redirected to the "Submit Ticket" page', async ({ browser }) => {
//     const page = await browser.visit('/organization')
//     await page
//       .waitForElement('#organization-input')
//       .type('#organization-input', 'submit-ticket-e2e-test')
...
// test('Admin on "Submit ticket" page should not be able to submit the form if fields are empty', async ({ browser }) => {
//   const page = await browser.visit('/organization')
//   await page
//     .waitForElement('#organization-input')
//     .type('#organization-input', 'submit-ticket-e2e-test')
...
test('Admin clicking on "Cancel" should lead back to the user ticket dashboard', async ({ browser }) => {
  const page = await browser.visit('/organization')
  await page
    .waitForElement('#organization-input')
    .type('#organization-input', 'submit-ticket-e2e-test')
